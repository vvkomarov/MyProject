...
public class BankAccount {
    ...
    public synchronized void deposit(BigDecimal money) {
        ...
        System.out.println("Поток: " + Thread.currentThread().getName() + " Добавляем " + money + ", на счету " + newBalance);
        balance = newBalance;
    }
    ...
    public synchronized void withdraw(BigDecimal money) throws NotEnoughMoneyException {
        ...
        balance = newBalance;
        System.out.println("Поток: " + Thread.currentThread().getName() + " Тратим " + money + ", на счету " + balance);
    }
