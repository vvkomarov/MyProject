package level14.lesson08.home10;
...
public class Solution {
    ...
    public static class NotIncapsulatedClass {
        ...
        private void processCastedObjects(Number a) {
            if (a instanceof Double) {
                System.out.println("Is double value infinite? " + ((Double) a).isInfinite());
            } else if (a instanceof Float) {
                System.out.println("Is float value defined? " + ((Float) a).isNaN());
            }
        }
    }
