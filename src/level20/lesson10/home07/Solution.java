package level20.lesson10.home07;
...
public class Solution implements Serializable, AutoCloseable {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        //solution.close();
        ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("solution.data"));
        oos.writeObject(solution);
        //oos.close();
        ObjectInputStream ois = new ObjectInputStream((new FileInputStream("solution.data")));
